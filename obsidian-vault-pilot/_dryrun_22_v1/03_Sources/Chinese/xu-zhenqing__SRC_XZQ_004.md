---
source_id: "SRC_XZQ_004"
title: "Baidu Baike: Xu Zhenqing"
title_zh: "百度百科·徐祯卿"
...
- **Source ID:** `SRC_XZQ_004`
- **Type:** encyclopedia
- **Reliability:** `D`
- **Verification:** `clue_only`
- **Citation:** clue_only
- **Belongs to person:** `xu-zhenqing` (`incoming/chinese/xu-zhenqing/`)
