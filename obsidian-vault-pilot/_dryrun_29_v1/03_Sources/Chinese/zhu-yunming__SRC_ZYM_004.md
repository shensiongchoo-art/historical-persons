---
source_id: "SRC_ZYM_004"
title: "Baidu Baike: Zhu Yunming"
title_zh: "百度百科·祝允明"
...
- **Source ID:** `SRC_ZYM_004`
- **Type:** encyclopedia
- **Reliability:** `D`
- **Verification:** `clue_only`
- **Citation:** clue_only
- **Belongs to person:** `zhu-yunming` (`incoming/chinese/zhu-yunming/`)
