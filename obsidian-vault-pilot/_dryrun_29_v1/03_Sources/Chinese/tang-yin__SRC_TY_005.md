---
source_id: "SRC_TY_005"
title: "Baidu Baike: Tang Yin"
title_zh: "百度百科·唐寅"
...
- **Source ID:** `SRC_TY_005`
- **Type:** encyclopedia
- **Reliability:** `D`
- **Verification:** `clue_only`
- **Citation:** clue_only
- **Belongs to person:** `tang-yin` (`incoming/chinese/tang-yin/`)
...
General reference; used as clue only, not primary support.
