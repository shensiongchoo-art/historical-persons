---
source_id: "SRC_WZM_005"
title: "Baidu Baike: Wen Zhengming"
title_zh: "百度百科·文徵明"
...
- **Source ID:** `SRC_WZM_005`
- **Type:** encyclopedia
- **Reliability:** `D`
- **Verification:** `clue_only`
- **Citation:** clue_only
- **Belongs to person:** `wen-zhengming` (`incoming/chinese/wen-zhengming/`)
