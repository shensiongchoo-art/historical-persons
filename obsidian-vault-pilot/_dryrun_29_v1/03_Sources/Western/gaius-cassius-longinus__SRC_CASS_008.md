---
source_id: "SRC_CASS_008"
title: "Wikipedia: Gaius Cassius Longinus"
source_type: "encyclopedia"
reliability_level: "D"
verification_status: "needs_verification"
data_source_folder: "incoming/western/gaius-cassius-longinus/"
used_for_claim_ids: []
...
- **Source ID:** `SRC_CASS_008`
- **Type:** encyclopedia
- **Reliability:** `D`
- **Verification:** `needs_verification`
- **Citation:** Wikipedia. Gaius Cassius Longinus.
- **Belongs to person:** `gaius-cassius-longinus` (`incoming/western/gaius-cassius-longinus/`)
...
Clue only; used for initial orientation
