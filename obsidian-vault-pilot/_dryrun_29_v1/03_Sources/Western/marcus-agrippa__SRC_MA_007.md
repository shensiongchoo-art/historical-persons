---
source_id: "SRC_MA_007"
title: "Britannica: Marcus Vipsanius Agrippa"
title_zh: "大英百科全书：阿格里帕"
...
---
# Britannica: Marcus Vipsanius Agrippa
...
- **Source ID:** `SRC_MA_007`
- **Type:** encyclopedia
- **Reliability:** `D`
- **Verification:** `clue_only`
- **Citation:** clue_only
- **Belongs to person:** `marcus-agrippa` (`incoming/western/marcus-agrippa/`)
...
General reference; used as clue only.
