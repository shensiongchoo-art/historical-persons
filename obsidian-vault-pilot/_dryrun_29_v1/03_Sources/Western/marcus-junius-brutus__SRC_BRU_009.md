---
source_id: "SRC_BRU_009"
title: "(no title)"
source_type: "tertiary_reference"
reliability_level: "C"
verification_status: "clue_only"
data_source_folder: "incoming/western/marcus-junius-brutus/"
used_for_claim_ids: []
...
- **Source ID:** `SRC_BRU_009`
- **Type:** tertiary_reference
- **Reliability:** `C`
- **Verification:** `clue_only`
- **Citation:** Wikipedia. 'Marcus Junius Brutus.' Accessed May 2026.
- **Belongs to person:** `marcus-junius-brutus` (`incoming/western/marcus-junius-brutus/`)
...
Used only as a cross-reference clue. Not a final authority for any confirmed claim.

## Review Warning

> ⚠️ This source note was generated from AI-collected staging metadata. As a D-level clue source, this note exists for completeness only — do not cite as evidence for any claim.
